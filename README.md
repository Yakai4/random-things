...
3️⃣`LZW` and `LZ78` are common compression algorithms(on the purpose of study)
both can also be viewed in juypter notebook format file below, including one simple video processing script using MoviePy(Thanks a lot)
have fun :)
希望对你有所帮助。</br>
😘😊😊😊😊😘</br>
